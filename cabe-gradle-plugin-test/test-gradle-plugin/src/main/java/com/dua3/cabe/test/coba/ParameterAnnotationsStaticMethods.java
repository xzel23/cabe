...
public class ParameterAnnotationsStaticMethods {
    ...
    public static void test() {
        ...
        // FIXME check(() -> new NotNullRecord(null, "b").toString(), null, "error: a is null");

        // check that annotated arguments to constructors work
        assert new B("hello", " world!").toString().equals("hello world!");
        // FIXME check(() -> new B(null, " world!").toString(), null, "error: a is null");
// FIXME       check(() -> new B("hello", null).toString(), null, "error: b is null");
    }
